...
<body style="background-color: #f8f9fa;" id="scrollspy1">
    ...
    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example rounded-2" tabindex="0">
        ...
        <div class="bg-photo-container">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousell" data-bs-interval="true">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active" data-bs-interval="4000">
                        ...
                        <div class="row" style="width: 100%;margin: 5% 0 0;padding:0% 5%;">
                            ...
                            <div class="col-md-8 p-0">
                                <img class="photo-of-car" src="../images/k5hd.png">
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item" data-bs-interval="4000">
        ...
        <!-- Search & Filter-->
        <form class="mb-0" method="POST" action="../client/clientpage.php#scrollspy2">
            <?php
            ...
            <div class="dropdown mt-3 text-center">
                ...
                <form method="GET" action="../client/clientpage.php#scrollspy2">
                    <button class="btn btn-lg btn-outline-dark mx-1" type="submit" name="clearfilter">Clear Filter</button>
                </form>
                <?php
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <?php while ($catrow = $catsq->fetch(PDO::FETCH_ASSOC)) {
                        extract($catrow); ?>
                        <li><a class="dropdown-item" onclick="window.location.href='clientpage.php?catname=<?php echo $category; ?>#scrollspy2';"><?php echo $category ?></a></li>
                    <?php } ?>
                    <li></li>
                </ul>
            </div>
        ...
        <!-- Store -->
        <?php if ($_GET['catname'] == null and $_POST['search'] == null) { ?>
            <?php
            ...
            <div class="container-fluid mt-3 px-5 pb-5">
                <h2 class="gaung-sin1 text-center">Store</h2>
                <div class="row">
                    <?php
                            ...
                            <div class="ttext-center">
                                <form class="m-0" method="POST" action="../client/managecart.php">
                                    ...
                                    if (strpos($_SESSION['name'], "b2b") !== false) { ?>
                                        <p class="p-style"><?php echo "Price: " . '$' . $price - ($price * 0.1); ?></p>
                                        <input type="hidden" id="price" name="price" value="<?php echo $price - ($price * 0.1) ?>">
                                    <?php } else { ?>
    ...
    <?php } else {
        ...
        <div id="searchresult" class="container-fluid mt-3 px-5 pb-5">
            <div class="row">
                <h2 class="gaung-sin1">Result for "<?php echo $name ?>"</h2>
                <?php
            ...
            <form action="../client/clientpage.php#scrollspy2" method="GET" class="text-center">
                <button type="submit" class="button_style" name="clearbutton">
                    Clear
                </button>
            </form>
            <?php
